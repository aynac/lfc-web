<section class="py-5 position-relative overflow-hidden"
    style="background: linear-gradient(135deg,  #577faa, #5db7ef, #6eb3fd52);">
    ...
    <div class="container text-center position-relative">
        ...
        <!-- Gradient Button -->
        <a href="/highlight" class="btn btn-lg px-5 py-3 d-inline-flex align-items-center text-white shadow-lg"
            style="
